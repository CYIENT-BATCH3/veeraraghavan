...
void can_read()
{
    ...
    RXB0CONbits.RXFUL = 0;
    if(data_byte[9] == 0xE0 && data_byte[10] == 0x45)
    nrcs_data_extract();
...
void can_write(char byte_speed_cmd_1,char byte_cc_status_2,char wl_status_3)
{
    ...
    set_mode(NORMAL_MODE_TRANS);
     ...
     TXB0SIDL = 0xE0;
     TXB0DLC = 0X08;
     TXB0D0 = byte_speed_cmd_1;
     TXB0D1 = byte_cc_status_2;
     TXB0D2 = wl_status_3;
     TXB0D3 = 0x00;
     TXB0D4 = 0X00;
     TXB0D5 = 0X00;
